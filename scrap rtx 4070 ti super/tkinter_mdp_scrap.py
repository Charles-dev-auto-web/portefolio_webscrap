...
def get_amazon_scrap():
    ...
    amaframe = Frame(root_ama)
    amaframe.pack()
    ll_scrap_a = Label(amaframe, text=scrap_amazon(), font=("Arial", 16))
    ll_scrap_a.pack()
...
def get_ldlc_scrap():
    ...
    ldlcframe = Frame(root_ldlc)
    ldlcframe.pack()
    ll_scrap_l = Label(ldlcframe, text=crte_ldlc(), font=("Arial", 16))
    ll_scrap_l.pack()
...
def afficher_interface_principale():
    ...
    ll = Label(frame, text="Bienvenue dans l'appllication !", font=("Arial", 25))
    ll.pack()
    ...
    ll_ldlc_btn.pack()
    ll_top_achat_btn = Label(frame, text="rtx 4070 ti super indisponibles sur TopAchat", font=("Arial", 16))
