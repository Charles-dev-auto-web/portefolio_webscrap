...
def crte_ldlc():
    ...
    for div in carte_ldlc:
        ...
        for c_ldlc in ldlc:
            ...
            if "RTX" in titre_ldlc and "4070" in titre_ldlc and "ti" in titre_ldlc and "super" in titre_ldlc and float(prix_ldlc) < 800:
                carte.append({
    ...
    for car in carte:
        exite += (f"{Fore.GREEN + car['titre_ldlc']} - {Fore.RED + car['prix_ldlc']} - {Fore.WHITE + car['liens_ldlc']} \n")
    return exite.strip()
...
def crte_ldlc_tk():
    ...
    for car in carte:
        exite += (f"{car['titre_ldlc']} - {car['prix_ldlc']} - {car['liens_ldlc']} \n")
    return exite.strip()
